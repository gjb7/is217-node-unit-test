...
var IEVersionRegEx = /MSIE (.*)/;

var mobileRegex = /(Mobile Safari|iPhone|IEMobile|Windows Phone)/;
...
exports.parse = function(userAgent) {
	...
	result.isMobile = exports.isMobile(userAgent);
	result.isTablet = exports.isTablet(userAgent);
	result.isDesktop = exports.isDesktop(userAgent);
	...
	while (match = parenRegEx.exec(userAgent)) {
		...
		parts.forEach(function(part) {
			...
			var MSIEVersionMatch = IEVersionRegEx.exec(part);
			if (MSIEVersionMatch) {
				result.isIE = true;
				result.version = MSIEVersionMatch[1];
			}
...
exports.isTablet = function(userAgent) {
	return (userAgent.indexOf('iPad') !== -1 || (userAgent.indexOf('Android') !== -1 && userAgent.indexOf('Mobile') === -1) || (userAgent.indexOf('Touch') !== -1 && userAgent.indexOf('Mobile') === -1));
}

exports.isDesktop = function(userAgent) {
	return (!exports.isMobile(userAgent) && !exports.isTablet(userAgent));
}
